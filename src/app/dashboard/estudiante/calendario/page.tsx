// pages/dashboard/estudiante/calendario.tsx
"use client";
import { useState } from 'react';

const EstudianteCalendarioPage = () => {
  ...
  return (
    <div className="p-8">
      ...
      <p className="text-lg text-[#2E2E2E] mb-4">Aquí puedes ver las fechas de tus próximos exámenes y planificarte mejor.</p>
      <div className="bg-[#E6D8C3] text-center p-2 font-semibold text-[#4A6472] rounded-t-lg">
        {new Date(año, mes).toLocaleString('es-ES', { month: 'long', year: 'numeric' })}
      </div>
      <div className="grid grid-cols-7 gap-2 mt-4 text-center bg-white shadow-lg rounded-b-lg p-4">
...
export default EstudianteCalendarioPage;
